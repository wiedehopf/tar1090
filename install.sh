...
srcdir=/run/readsb
repo="https://github.com/redesigned-train/tar1090"
...
if ! { [[ "$1" == "test" ]] && cd "$gpath/git-db"; }; then
    DB_VERSION_NEW=$(curl --silent --show-error "https://raw.githubusercontent.com/redesigned-train/tar1090-db/master/version")
